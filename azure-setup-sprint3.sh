...
# ACR + ACI + Storage Account (volume persistente)
# Java 17 + Spring Boot + MySQL 8
# =================================================================
...
# ── 4. Storage Account + File Share (volume persistente) ─────
...
log "Preparando YAML do ACI com volume..."
sed \
...
ok "Container Group criado com volume persistente!"
